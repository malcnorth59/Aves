...
|6
|IO1
|Enables access to additional I/O space between 0xFD00 and 0xFDFF. When this bit is set there is no access to anyROM or RAM banks at this address

|5
|IO2
|Enables access to additional I/O space between 0xFC00 and 0xFCFF. When this bit is set there is no access to anyROM or RAM banks at this address

|4
|DPM
|Enables access to a 4K window at 0xE000 for dual port memory. When this bit is set there is no access to anyROM or RAM banks at this address
